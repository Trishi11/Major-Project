...
const Landing = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const card1Section = document.getElementById('card1');
      const card2Section = document.getElementById('card2');
      const authSection = document.getElementById('auth-section');
      
      if (aboutSection) {
        const rect = aboutSection.getBoundingClientRect();
        setIsVisible(prev => ({ ...prev, about: rect.top <= window.innerHeight * 0.75 }));
      }
      
      if (card1Section) {
        const rect = card1Section.getBoundingClientRect();
        setIsVisible(prev => ({ ...prev, card1: rect.top <= window.innerHeight * 0.75 }));
      }
      
      if (card2Section) {
        const rect = card2Section.getBoundingClientRect();
        setIsVisible(prev => ({ ...prev, card2: rect.top <= window.innerHeight * 0.75 }));
      }
      
      if (authSection) {
        const rect = authSection.getBoundingClientRect();
        setIsVisible(prev => ({ ...prev, auth: rect.top <= window.innerHeight * 0.75 }));
      }
    };
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="relative z-10 container mx-auto px-6 text-center">
          <div className="max-w-4xl mx-auto space-y-6 animate-fade-in">
            ...
            <Button 
              ...
              size="lg" 
              className="mt-8 text-lg px-8 py-6 shadow-2xl shadow-primary/30 hover:shadow-primary/50 transition-all bg-gradient-to-r from-primary to-secondary text-white"
            >
              Enter Lab
            </Button>
            <Button 
              ...
              size="lg" 
              variant="outline"
              className="mt-4 text-lg px-8 py-6 shadow-2xl shadow-primary/30 hover:shadow-primary/50 transition-all ml-4"
            >
              Get Started
      ...
      {/* About Section */}
      <section id="about-section" className={`py-16 bg-card/30 backdrop-blur-sm transition-all duration-700 ${isVisible.about ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto space-y-16">
            ...
            <div className="space-y-12">
              ...
              <Card id="card1" className={`overflow-hidden bg-card/50 border-border backdrop-blur-sm hover:shadow-lg hover:shadow-primary/10 transition-all ${isVisible.card1 ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
              ...
              <Card id="card2" className={`overflow-hidden bg-card/50 border-border backdrop-blur-sm hover:shadow-lg hover:shadow-secondary/10 transition-all ${isVisible.card2 ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
                <div className="grid md:grid-cols-2 gap-0">
      ...
      {/* Auth Section */}
      <section id="auth-section" className={`py-16 bg-background transition-all duration-700 ${isVisible.auth ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        <div className="container mx-auto px-6">
