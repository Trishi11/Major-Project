...
export const experimentMaterials: Record<string, ExperimentMaterials> = {
  ...
  combustion: {
    ...
    chemicals: [
      { id: "magnesium", name: "Magnesium Ribbon", formula: "Mg", color: "#cccccc", state: "solid" },
      { id: "oxygen", name: "Oxygen", formula: "O₂", color: "#4fc3f7", state: "gas" },
    ],
    equipment: [
      { id: "burner", name: "Bunsen Burner", type: "burner" },
      { id: "spoon", name: "Combustion Spoon", type: "other" },
    ],
    steps: [
      "Click the Bunsen burner to light it",
      "Position the combustion spoon near the flame",
      "Heat until temperature reaches ignition point (400°C)",
      "Observe bright white combustion flame",
      "Watch white magnesium oxide smoke formation"
    ],
    reactions: [
      {
