...
import KMnO4ReductionExperiment from "@/lab/components/experiments/KMnO4ReductionExperiment";
      ...
      <BrowserRouter>
        <AuthProvider>
          <Routes>
            ...
            <Route path="/lab/reduction-reaction/run" element={<KMnO4ReductionExperiment />} />
